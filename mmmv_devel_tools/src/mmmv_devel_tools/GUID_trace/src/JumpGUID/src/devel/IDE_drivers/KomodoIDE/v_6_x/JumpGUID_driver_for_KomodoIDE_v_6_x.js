...
guidtrace.setup.stack_of_GUIDS_cursor_movement = "current_cursor";
/*guidtrace.setup.JumpGUID_home_path =s_home+"/2ikeselaulja/Projektid/progremise_infrastruktuur/progremise_t66vahendid/IDE_t2iustusi/GUID_trace/vana_originaal/JumpGUID/JumpGUID/src/implementation_1";*/
guidtrace.setup.JumpGUID_home_path =s_home+"/2ikeselaulja/Projektid/progremise_infrastruktuur/progremise_t66vahendid/IDE_t2iustusi/GUID_trace/varukoopiad/2012_06_24_seis/vana_originaal/JumpGUID/JumpGUID/src/implementation_1";
guidtrace.setup.wild_text_file_path =s_home+"/2ikeselaulja/tmp/wild.txt";

ar_project_folder_paths.push(s_home+"/2ikeselaulja/m_local/seif/Dokumendikogu/orjat66alane/kohti_kuhu_on_kandideeritud/olen_nendega_kontakti_v8tnud/Eesti_Energia/2012_05/Meelis_Kerbo/EE_testylesanne/EE_testylesanne/IDE/spring_toolsuite_workspace");
/*
ar_project_folder_paths.push(s_home+"/2ikeselaulja/Projektid/enda2ri/tooted/aktiivsed/InspektoVeeb/inspekto/inspekto_liivakast/inspekto/src/lib/sitespecific/javascript");
ar_project_folder_paths.push(s_home+"/2ikeselaulja/Projektid/progremise_infrastruktuur/teeke/raudrohi/raudrohi_liivakast/raudrohi/src/devel");
*/
    ...
    try {
        ...
        if (2 <= n) {
            ...
            for (i = 0; i < nnn; i++) {
                ...
                if (a_pair == null) {
                    raudrohi.tmg('4bf0b395-e3ff-4528-a703-51ec3d98f05d', 'a_pair==null ' + 'haystack_string==' + haystack_string + 'needle_string==' + needle_string + ' n==' + n + ' ');
                } // if
                ar.push(a_pair.a);
                a_pair1 = raudrohi.base.bisect(a_pair.b, needle_string);
                if (a_pair1 == null) {
                    raudrohi.tmg('4bf0b395-913f-4fac-1623-4cc4480d7d85', 'a_pair1==null ' + 'haystack_string==' + haystack_string + 'needle_string==' + needle_string + ' n==' + n + ' ');
                } // if
                ar.push(a_pair1.a);
                s_hay = a_pair1.b;
            } // for
        ...
        if (modulus == 1) {
            a_pair = raudrohi.base.bisect(s_hay, needle_string);
            if (a_pair == null) {
                raudrohi.tmg('4bf0b395-1a70-4814-7585-188b2e91144c', 'a_pair==null ' + 'haystack_string==' + haystack_string + 'needle_string==' + needle_string + ' n==' + n + ' ');
            } // if
            ar.push(a_pair.a);
        } // if
        return ar;
    } catch(err) {
        raudrohi.tmg('4bf0b395-83e8-4466-8104-4a9f0861b051', err);
    } // catch
...
function file_exists_sev(a_file_path_candidate) {
    var cmd = ' ruby '+guidtrace.setup.JumpGUID_home_path + "/file_exists.rb " + a_file_path_candidate
...
var cm_update_coords = cm_cd2fp_rubyscript + ' ruby '+fp_rubyscript + " wild_text_2_guids " + fp_coords + " " + fp_wild_text + " ; ";
...
while (b_search_on === true) {
    ...
    var cm_move = cm_cd2fp_rubyscript + ' ruby '+fp_rubyscript + " " + move_command + " " + fp_coords + " " + fp_project + " ; ";
